...
// League data for display on landing page
const leagues = [
  {
    id: 'premier-league',
    name: 'Premier League',
...
export default function LeagueTablesLanding() {
  return (
    <div>
      <h1 className="text-3xl font-bold mb-6">League Tables</h1>
      <p className="text-gray-300 mb-8">
        View current standings for major football leagues around the world.
      </p>
            ...
            <div className={`bg-gradient-to-br ${league.color} rounded-lg p-6 h-full shadow-lg`}>
              ...
              <div className="mt-4 pt-4 border-t border-white/20">
                ...
                <div className="text-white/70 text-xs mt-1">
                  Includes team positions, points, and form
                </div>
              </div>
            </div>
          </Link>
